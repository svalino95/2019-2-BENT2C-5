...
namespace AlquilerCanchas.Controllers
{
    public class TurnosController : Controller
    {
        ...
        public TurnosController(AlquilerCanchasDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,horaInicio,horaFin")] Turno turno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,horaInicio,horaFin")] Turno turno)
        {
            if (id != turno.Id)
            {
                return NotFound();
